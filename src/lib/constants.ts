export const QUESTIONS = [
  {
    ...
    choices: ["Gaming", "Exploring", "Crafting", "Reading", "Sports"],
  },
  {
    question_id: 2,
    question: "How do you prefer to spend your weekends?",
    dimension: "Lifestyle",
    choices: ["Adventure", "Relaxation", "Socializing"],
  },
  {
    question_id: 3,
    question: "What qualities do you value most in a friend?",
    dimension: "Interpersonal",
    choices: ["Loyalty", "Humor", "Empathy", "Adventurousness"],
  },
  {
    question_id: 4,
